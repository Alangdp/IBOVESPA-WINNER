          ...
          <div className="indexes py-0 w-full">
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="w-full">
                <h3 className="font-medium text-lg text-[#F46D22]">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 items-center w-full gap-1">
                  {[
                    {
                      label: "D.Y",
                      value: indicators.dy?.actual.toFixed(2),
                      unit: "%",
                      key: "dy",
                    },
                    {
                      label: "P/L",
                      value: indicators.p_l?.actual.toFixed(2),
                      key: "p_l",
                    },
                    {
                      label: "PEG RATIO",
                      value: indicators.peg_Ratio?.actual.toFixed(2),
                      key: "peg_Ratio",
                    },
                    {
                      label: "P/VP",
                      value: indicators.p_vp?.actual.toFixed(2),
                      key: "p_vp",
                    },
                    {
                      label: "EV/EBIT",
                      value: indicators.ev_ebit?.actual.toFixed(2),
                      key: "ev_ebit",
                    },
                    {
                      label: "P/EBITDA",
                      value: indicators.p_ebita?.actual.toFixed(2),
                      key: "p_ebita",
                    },
                    {
                      label: "P/EBIT",
                      value: indicators.p_ebit?.actual.toFixed(2),
                      key: "p_ebit",
                    },
                    {
                      label: "VPA",
                      value: indicators.vpa?.actual.toFixed(2),
                      key: "vpa",
                    },
                    {
                      label: "P/ATIVO",
                      value: indicators.p_ativo?.actual.toFixed(2),
                      key: "p_ativo",
                    },
                    {
                      label: "LPA",
                      value: indicators.lpa?.actual.toFixed(2),
                      key: "lpa",
                    },
                    {
                      label: "P/SR",
                      value: indicators.p_sr?.actual.toFixed(2),
                      key: "p_sr",
                    },
                    {
                      label: "P/CAP. GIRO",
                      value: indicators.p_capitlgiro?.actual.toFixed(2),
                      key: "p_capitlgiro",
                    },
                    {
                      label: "P/ATIVO CIRC. LIQ",
                      value: indicators.p_ativocirculante?.actual.toFixed(2),
                      key: "p_ativocirculante",
                    },
                  ].map((indicator, index) => (
                    <div
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <div className="Value font-medium text-bl brightness-110 text-lg">
                          {indicator.value}
                          {indicator.unit}
                        </div>
                        <HistoryModal
                          ...
                          indicatorKey={
                            indicator.key as keyof FinancialIndicators
                          }
                        >
                          <img
                            alt="chart"
                            className="h-6 border border-zinc-600 text-zinc-600 cursor-pointer"
                            src={ShowGraph}
                          />
                        </HistoryModal>
                      </div>
                  ...
                  {[
                    {
                      label: "DIV. LIQ/PL",
                      value:
                        indicators.dividaliquida_patrimonioliquido?.actual.toFixed(
                          2
                        ),
                      key: "dividaliquida_patrimonioliquido",
                    },
                    {
                      label: "DIV. LIQ/EBITDA",
                      value: indicators.dividaliquida_ebitda?.actual.toFixed(2),
                      key: "dividaliquida_ebitda",
                    },
                    {
                      label: "DIV. LIQ/EBIT",
                      value: indicators.dividaliquida_ebit?.actual.toFixed(2),
                      key: "dividaliquida_ebit",
                    },
                    {
                      label: "PASSIVO/ATIVOS",
                      value: indicators.passivo_ativo?.actual.toFixed(2),
                      key: "passivo_ativo",
                    },
                    {
                      label: "LIQ. CORRENTE",
                      value: indicators.liquidezcorrente?.actual.toFixed(2),
                  ...
                  <div className="flex items-center w-full">
                    <div className="grid grid-cols-2 gap-1 w-full">
                      {[
                        {
                          label: "MARGEM BRUTA",
                          value: indicators.margembruta?.actual.toFixed(2),
                          unit: "%",
                          key: "margembruta",
                        },
                        {
                          label: "MARGEM EBITDA",
                          value: indicators.margemebitda?.actual.toFixed(2),
                          unit: "%",
                          key: "margemebitda",
                        },
                        {
                          label: "MARGEM EBIT",
                          value: indicators.margemebit?.actual.toFixed(2),
                          unit: "%",
                          key: "margemebit",
                        },
                        {
                          label: "MARGEM LÍQUIDA",
                          value: indicators.margemliquida?.actual.toFixed(2),
                          unit: "%",
                          key: "margemliquida",
                        },
                      ].map((indicator, index) => (
                  ...
                  <div className="flex items-center w-full">
                    <div className="grid grid-cols-2 gap-1 w-full">
                      {[
                        {
                          label: "ROE",
                          value: indicators.roe?.actual.toFixed(2),
                          unit: "%",
                          key: "roe",
                        },
                        {
                          label: "ROA",
                          value: indicators.roa?.actual.toFixed(2),
                          unit: "%",
                          key: "roa",
                        },
                        {
                          label: "ROIC",
                          value: indicators.roic?.actual.toFixed(2),
                          unit: "%",
                          key: "roic",
                        },
                        {
                          label: "GIRO ATIVOS",
                          value: indicators.giro_ativos?.actual.toFixed(2),
                          unit: "%",
                          key: "giro_ativos",
                        },
                      ].map((indicator, index) => (
                      ...
                      {[
                        {
                          ...
                          value: indicators.receitas_cagr5?.actual.toFixed(2),
                          unit: "%",
                          key: "receitas_cagr5",
                        },
                        {
