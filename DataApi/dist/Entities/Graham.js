import { GranhamProtocol, } from '../interfaces/GranamProtocal.type';
...
// TODO - REFAZER TUDO
// @ts-ignore
export class Granham extends GranhamProtocol {
    constructor(stock) {
        super();
    ...
    calculateYearGrowth(stock, numberYears) {
        try {
